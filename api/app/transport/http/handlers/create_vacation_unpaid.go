...
func CreateVacationUnpaid(c *core.Core, w http.ResponseWriter, r *http.Request) {
	w.Header().Add("Content-Type", "application/json")
	errorContainer := httperror.ErrorResponse{}

	decoder := json.NewDecoder(r.Body)
	var message domain.CreateVacationUnpaidRequest
	...
	result, err := c.CreateVacationUnpaid(r.Context(), &message)
	if err != nil {
		switch {
